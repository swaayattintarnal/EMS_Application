...
const EmployeeProfile = ({ employee: employee, onBack, onEmployeeUpdate }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            <div
                className="bg-gradient-to-r from-indigo-300 to-purple-300 text-white relative"
                style={{
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            {employee.documents.personal[3].files[0] ? (
                                ...
                                <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-2xl border-4 border-green-200">
